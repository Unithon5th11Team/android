...
public class RecommendActivity extends AppCompatActivity {
	...
	@BindView(R.id.recommendRecycler) protected RecyclerView recommendRecycler;
	@BindView(R.id.activity_recommend_tv) protected AppCompatTextView mRcommendTv;
	...
	public class RecommendViewHolder extends RecyclerView.ViewHolder {
		...
		@BindView(R.id.item_recommend_iv) public AppCompatImageView mRecommendIv;
		@BindView(R.id.recommend_title) public AppCompatTextView title;
		@BindView(R.id.recommend_location) public AppCompatTextView location;
		@BindView(R.id.recommend_date) public AppCompatTextView date;
		@BindView(R.id.recommend_summary) public AppCompatTextView summary;
