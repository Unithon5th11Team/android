...
public abstract class RecyclerFragment extends BaseFragment implements
        ...
        , OnMoreListener
{
    @BindView(R.id.activity_fragment_recyclerView) SuperRecyclerView recyclerView;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView.setRefreshingColorResources(R.color.point_424C57, R.color.point_5FA9D0, R.color.white, R.color.point_E47B75);
