...
public class CategoryViewPagerFragment extends BaseFragment {
	...
	public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
		return inflater.inflate(R.layout.fragment_category_viewpager, container, false);
	}
	...
	public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
		...
		for (CategoryCategory category : CategoryCategory.values()) {
			mAdapter.addFragment(CategoryCategoryFragment.newInstance(category), getString(category.getResId()));
		}
