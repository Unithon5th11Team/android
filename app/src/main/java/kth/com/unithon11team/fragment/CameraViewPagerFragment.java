...
public class CameraViewPagerFragment extends BaseFragment {
	...
	public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
		return inflater.inflate(R.layout.fragment_camera_viewpager, container, false);
	}
	...
	public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
		...
		for (CameraCategoty category : CameraCategoty.values()) {
			mAdapter.addFragment(CameraCategoryFragment.newInstance(category), getString(category.getResId()));
		}
